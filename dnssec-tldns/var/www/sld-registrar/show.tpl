...
<tr><td>Nserver1: </td><td>{{index .nserver1_name 0}}<br />Glue-IP: {{index .nserver1_ip 0}}</td></tr>
<tr><td>Nserver2: </td><td>{{index .nserver2_name 0}}<br />Glue-IP: {{index .nserver2_ip 0}}</td></tr>
<tr><td>Nserver3: </td><td>{{index .nserver3_name 0}}<br />Glue-IP: {{index .nserver3_ip 0}}</td></tr>
<tr><td><br /></td><td></td></tr>
