...
<tr><td><br /></td></tr>
<tr><td>Nserver1:</td><td><input type="text" name="nserver1_name" value="{{index .nserver1_name 0}}" /> Glue-IP: <input type="text" name="nserver1_ip" value="{{index .nserver1_ip 0}}" /></td></tr>
